...
<div class="body-content">
	...
	<h1><a href="blog-details.html"> @if(session()->get('language') == 'bangla') {{ $blog->post_title_bn }}  
        @else {{ $blog->post_title_en }} @endif</a></h1>
	
    <span class="date-time"> {{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>
	<p>@if(session()->get('language') == 'bangla') {!! Str::limit($blog->post_details_bn, 300 ) !!}  
       @else {!! Str::limit($blog->post_details_en, 300 ) !!}
       @endif
    </p>
