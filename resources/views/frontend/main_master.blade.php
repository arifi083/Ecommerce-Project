...
<!-- Bootstrap Core CSS   {{ asset('frontend/') }}-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><strong><span id="pname"></span></strong></h5>  <!-- product name-->
              ...
              rows += `<tr>
                ...
                ${value.product.discount_price == null
                    ...
                    `${value.product.discount_price} <span>${value.product.selling_price}</span>`
				   	...
				   	<td class="col-md-2">
             <button  class="btn btn-primary icon" type="button" title="Add Cart" id="${value.product_id}"
...
<script type="text/javascript">
      function cart(){
        $.ajax({
          ...
          success:function(response){
           // console.log(response)
            ...
            $.each(response.carts, function(key,value){
              rows += `<tr>
				   	<td class="col-md-2"><img src="/${value.options.image}" alt="imga" style="height:80px; width:80px"></td>
				  	<td class="col-md-2">
        ...
        <td class="col-md-2">
          ...
          <button type="submit" class="btn btn-success" id=${value.rowId} onclick="cartIncrement(this.id)">+</button>
        </td>
             <td class="col-md-2">
