...
<div class="panel panel-default checkout-step-01">
	...
	<form class="register-form" method="POST" action="{{ route('checkout.store') }}">   <!-- start Form --> 
			...
			<div class="form-group">
				...
				<input type="text" name="shipping_name" class="form-control unicase-form-control text-input" 
				 id="exampleInputEmail1" placeholder="Full Name" value="{{ Auth::user()->name}}" required="">
			</div> <!-- End Form Group -->
			...
			<div class="form-group">
				...
				<input type="text" name="post_code" class="form-control unicase-form-control text-input" 
				 id="exampleInputEmail1" placeholder="postal code"  required="">
			</div> <!-- End Form Group -->
		...
		<div class="col-md-6 col-sm-6 already-registered-login">
			...
			<div class="form-group">
			  <h5><b>State Select</b><span class="text-danger">*</span></h5>
			   <div class="controls">
			      <select name="state_id" id=""  class="form-control" required="">
...
<!-- shipDistrict  and shipState js file -->
