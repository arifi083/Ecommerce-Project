...
<header class="header-style-1"> 
      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @if(session()->get('language') == 'bangla') শৃঙ্খলা ট্র্যাকিং @else Order Tracking @endif</a></li>
        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            @if(session()->get('language') == 'bangla') বাংলা @else Language @endif </span><b class="caret"></b></a>
  ...
  <ul class="nav navbar-nav">
    ...
    @if(session()->get('language') == 'bangla') হোম  @else Home @endif </a> </li>
...
<li class="dropdown yamm mega-menu"> <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
  @if(session()->get('language') == 'bangla') {{ $category->category_name_bn }}  @else {{ $category->category_name_en }} @endif</a>
               ...
               @php
                ...
                <ul class="links">
                  <li>
                      ...
                      @if(session()->get('language') == 'bangla') {{ $subsubcategory->subsubcategory_name_bn }} @else {{ $subsubcategory->subsubcategory_name_en }}  @endif</a>
                  </li>
    ...
    <li>
      ...
      @if(session()->get('language') == 'bangla') শপ
      @else Shop @endif</a>
    </li>
      ...
      <div class="modal-body">
        <form action="{{ route('order.tracking') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <input type="text" name="code" class="form-control" requird="" placeholder="your order invoice number">
          </div>
          <button type="submit" class="btn btn-danger" style="margin-left: 17px;">Track Now</button>
        </form>
      </div>
