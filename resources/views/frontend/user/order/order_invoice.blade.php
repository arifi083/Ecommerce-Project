    ...
    <tr>
        ...
        <td align="right">
            <pre class="font" >
               ...
               Email:atifarif083@gmail.com <br>
               Mob: 01679364179 <br>
...
<h3>Products</h3>
  ...
  <table width="100%">
    ...
    <tbody>
      ...
      <tr class="font">
        ...
        <td align="center">BDT {{ $item->price }}</td>
        <td align="center">BDT {{ $item->price * $item->qty}} </td>
      </tr>
      @endforeach
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span>BDT {{ $order->amount}} </h2>
            <h2><span style="color: green;">Total:</span>BDT {{ $order->amount}} </h2>
