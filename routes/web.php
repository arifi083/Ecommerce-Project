...
|
*/
//DeleteControoler data delete korar jnno
...
Route::middleware(['auth:admin'])->group(function(){
  ...
  Route::get('/admin/edit/profile',[AdminProfileController::class,'AdminProfileEdit'])->name('admin.edit.profile');
...
//Frontend indexcontroller product details url
...
Route::group(['prefix'=>'user','middleware' => ['user','auth'],'namespace'=>'User'],function(){
 ...
 Route::get('/cart-cartDecrement/{rowId}', [CartPageController::class,'cartDecrement']);
