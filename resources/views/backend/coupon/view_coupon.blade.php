...
<tbody>
	...
	<td>
		   <!--if coupon validity is greater than current date -->
	...
	<td width="25%">
		...
		<a href="{{ route('coupon.delete',$item->id) }}" class="btn btn-danger" title="Delete Coupon" id="delete"><i class="fa fa-trash"></i></a>
