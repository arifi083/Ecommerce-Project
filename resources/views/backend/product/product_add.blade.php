		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
<form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">   <!-- this is our form -->
    ...
    <div class="row">  <!-- start fourth row -->
       ...
       <div class="col-md-4"> <!-- col-md-4 -->
          <div class="form-group">
                ...
                <div class="controls">
                   <input type="text" name="product_tags_bn" class="form-control" value="" data-role="tagsinput"  required=""> 
       ...
       <div class="col-md-4">
          <div class="form-group">
               ...
               <div class="controls">
                  <input type="text" name="product_size_bn" class="form-control" value="ছোট,মধ্যম,বড়" data-role="tagsinput"  required=""> 
    ...
    <div class="row">  <!-- start five row -->
       ...
       <div class="col-md-4"> 
           <div class="form-group">
               ...
               <div class="controls">
                  <input type="text" name="product_color_bn" class="form-control" value="লাল,কালো,নীল" data-role="tagsinput" required=""> 
  ...
  <div class="row">  <!-- start seven row -->
    ...
    <div class="col-md-6"> 
        <div class="form-group">
           ...
           <div class="controls">
              <textarea name="short_descp_bn" id="textarea" class="form-control" required placeholder="Textarea text"  required=""></textarea>
            </div>
