...
<div class="side-menu animate-dropdown outer-bottom-xs">
    ...
    <ul class="nav">
        ...
        data-toggle="dropdown"><i class="icon {{ $category->category_icon }}" aria-hidden="true"></i>
...
<!-- category ,subcategory,subsubcategory insert korar por nicher ai 3 ta li delete kre dibe -->
