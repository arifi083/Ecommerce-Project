...
<li class="{{ ($route == 'all.subsubcategory')? 'active':'' }}"><a href="{{ route('all.subsubcategory') }}"><i class="ti-more"></i>AllSub->SubCategory</a></li>
...
<li class="{{ ($route == 'manage.slider')? 'active':'' }}"><a href="{{ route('manage.slider') }}"><i class="ti-more"></i>Manage Slider</a></li>
        ...
        <li class="treeview {{ ($prefix=='/coupons')? 'active':'' }}">
          ...
          <ul class="treeview-menu">
<li class="{{ ($route == 'manage-coupons')? 'active':'' }}"><a href="{{ route('manage-coupons') }}"><i class="ti-more"></i>Manage Coupon</a></li>
          </ul>
        </li> 	
        ...
        <li class="treeview {{ ($prefix=='/shipping')? 'active':'' }}">
          ...
          <ul class="treeview-menu">
    <li class="{{ ($route == 'manage-division')? 'active':'' }}"><a href="{{ route('manage-division') }}"><i class="ti-more"></i>Ship Divison</a></li>
